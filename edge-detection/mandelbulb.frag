...
void main()
{
   ...
   // Increase to zoom in
    ...
    //vec3 col = colorGradient( uv, RASPBERRY, GREEN, 0.5) ;
   ...
   //vec3 c1 = vec3( clamp(0.5-cos(es * 20.0)/2.0, 0.0, 1.0), clamp(0.5-cos(es * 30.0)/2.0, 0.0, 1.0) , clamp(0.5-cos(es * 20.0)/2.0, 0.0, 1.0) ); // green, purple, washed out
     ...
     //vec3 c1 = vec3( sin(es * 20.0)*0.5+ 0.5, sin(es * 30.0)*0.5 + 0.5,  0.5); 
